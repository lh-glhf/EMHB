...
def create_parser():
    ...
    parser.add_argument('--data', type=str, required=True, default='ETTh1', help='data_provider')
    parser.add_argument('--root_path', type=str, default='./data_provider/ETT/',
                        help='root path of the data_provider file')
    parser.add_argument('--data_path', type=str, default='ETTh1.csv', help='data_provider file')
    ...
    parser.add_argument('--do_predict', action='store_true',
                        help='whether to predict unseen future data_provider')
    ...
    parser.add_argument('--cols', type=str, nargs='+',
                        help='certain cols from the data_provider files as the input features')
    parser.add_argument('--num_workers', type=int, default=0, help='data_provider loader num workers')
    parser.add_argument('--itr', type=int, default=1, help='experiments times')
    parser.add_argument('--train_epochs', type=int, default=6, help='train epochs')
    parser.add_argument('--batch_size', type=int, default=32, help='batch size of train input data_provider')
    ...
    parser.add_argument('--inverse', action='store_true', help='inverse output data_provider',default=False)

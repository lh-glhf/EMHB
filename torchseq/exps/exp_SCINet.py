...
from ..data_provider.data_loader import Dataset_ETT_hour_inverse, Dataset_ETT_minute_inverse, Dataset_Custom_inverse, Dataset_Pred_inverse
...
class Exp_SCINet(Exp_Basic):
    ...
    def _get_data(self, flag):
        ...
        data_dict = {
            'ETTh1':Dataset_ETT_hour_inverse,
            'ETTh2':Dataset_ETT_hour_inverse,
            'ETTm1':Dataset_ETT_minute_inverse,
            'ETTm2':Dataset_ETT_minute_inverse,
            'WTH':Dataset_Custom_inverse,
            'ECL':Dataset_Custom_inverse,
            'Solar':Dataset_Custom_inverse,
            'custom':Dataset_Custom_inverse,
        }
    ...
    def valid(self, valid_data, valid_loader, criterion):
        ...
        if self.args.stacks == 1:
            ...
            pred_scales = np.concatenate(pred_scales, axis=0)
            true_scales = np.concatenate(true_scales, axis=0)
            ...
            mae, mse, rmse, mape, mspe, smape, wape, msmape = metric(preds, trues)
            maes, mses, rmses, mapes, mspes, smapes, wapes, msmapes = metric(pred_scales, true_scales)
            print(
                'final --> normed mse:{}, mae:{}, rmse:{}, mape:{}, mspe:{}, smape:{}, wape:{}, msmape: {}'.format(mse,
                                                                                                                   mae,
                                                                                                                   rmse,
                                                                                                                   mape,
                                                                                                                   mspe,
                                                                                                                   ...
                                                                                                                   msmape))
            print(
                'final --> denormed mse:{}, mae:{}, rmse:{}, mape:{}, mspe:{}, smape:{}, wape:{}, msmape: {}'.format(
                    mses,
                    maes,
                    rmses,
                    mapes,
            ...
            pred_scales = np.concatenate(pred_scales, axis=0)
            true_scales = np.concatenate(true_scales, axis=0)
            mid_scales = np.concatenate(mid_scales, axis=0)
            ...
            mae, mse, rmse, mape, mspe, smape, wape, msmape = metric(mids, trues)
            maes, mses, rmses, mapes, mspes, smapes, wapes, msmapes = metric(mid_scales, true_scales)
            print('mid --> normed mse:{}, mae:{}, rmse:{}, mape:{}, mspe:{}, smape:{}, wape:{}, msmape: {}'.format(mse, mae, rmse, mape,
                                                                                                mspe, smape, wape,
                                                                                                msmape))
            print('mid --> denormed mse:{}, mae:{}, rmse:{}, mape:{}, mspe:{}, smape:{}, wape:{}, msmape: {}'.format(mses, maes, rmses, mapes,
                                                                                                mspes, smapes, wapes,
                                                                                                msmapes))

            mae, mse, rmse, mape, mspe, smape, wape, msmape = metric(preds, trues)
            maes, mses, rmses, mapes, mspes, smapes, wapes, msmapes = metric(pred_scales, true_scales)
            print('final --> normed mse:{}, mae:{}, rmse:{}, mape:{}, mspe:{}, smape:{}, wape:{}, msmape: {}'.format(mse,
                                                                                                                   mae,
                                                                                                                   rmse,
                                                                                                                   mape,
                                                                                                                   mspe,
                                                                                                                   ...
                                                                                                                   msmape))
            print(
                'final --> denormed mse:{}, mae:{}, rmse:{}, mape:{}, mspe:{}, smape:{}, wape:{}, msmape: {}'.format(mses,
                                                                                                                   maes,
                                                                                                                   rmses,
                                                                                                                   mapes,
                                                                                                                   mspes,
    ...
    def test(self, setting, evaluate=False):
        ...
        if self.args.stacks == 1:
            ...
            mae, mse, rmse, mape, mspe, smape, wape, msmape = metric(mids, trues)
            maes, mses, rmses, mapes, mspes, smapes, wapes, msmapes = metric(mid_scales, true_scales)
            print('mid --> normed mse:{}, mae:{}, rmse:{}, mape:{}, mspe:{}, smape:{}, wape:{}, msmape: {}'.format(mse,
                                                                                                                   mae,
                                                                                                                   rmse,
                                                                                                                   mape,
                                                                                                                   mspe,
                                                                                                                   ...
                                                                                                                   msmape))
            print(
                'mid --> denormed mse:{}, mae:{}, rmse:{}, mape:{}, mspe:{}, smape:{}, wape:{}, msmape: {}'.format(mses,
                                                                                                                   maes,
                                                                                                                   rmses,
                                                                                                                   mapes,
                                                                                                                   mspes,
        ...
        if self.args.save:
            ...
            mae, mse, rmse, mape, mspe, smape, wape, msmape = metric(preds, trues)
            print('Test:mse:{}, mae:{}, rmse:{}, mape:{}, mspe:{}, smape:{}, wape:{}, msmape: {}'.format(mse,
                                                                                                                   mae,
                                                                                                                   rmse,
                                                                                                                   mape,
                                                                                                                   mspe,
